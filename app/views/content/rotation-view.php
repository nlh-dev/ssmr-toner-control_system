<div class="p-4 sm:ml-64">
    ...
    <div class="w-full flex justify-end items-center my-4">
        <button data-modal-target="addToners-modal" data-modal-toggle="addToners-modal" class="block text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center" type="button">
            <div class="flex items-center justify-center">
                ...
                <span>Añadir Rotación de Tóner</span>
            </div>
        </button>
    </div>
    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
        <table class="w-full text-sm text-left rtl:text-right text-gray-500">
            <thead class="text-base text-white uppercase bg-red-700">
                <tr>
